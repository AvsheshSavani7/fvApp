...
import CheckListSummaryButton from "./CheckListSummaryButton";

const CheckListProjectFloorSummary = ({ addedFloors, floor, index }) => {
  return (
    <Grid
      item
      xs={12}
...
export default CheckListProjectFloorSummary;
